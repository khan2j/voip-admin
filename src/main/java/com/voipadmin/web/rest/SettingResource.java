...
/**
 * REST controller for managing {@link com.voipadmin.domain.Setting}.
 */
@RestController
@RequestMapping("/api")
public class SettingResource {
     ...
     */
    @GetMapping("/settings")
    public ResponseEntity<List<SettingDTO>> getAllSettings(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
