...
export class OptionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.optionService
      ...
      .subscribe(
        (res: HttpResponse<IOption[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IOption[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
