...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('voipadminApp.department.home.title');
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('voipadminApp.department.home.createOrEditLabel');
  ...
  it('should create and save Departments', async () => {
    ...
    await promise.all([departmentUpdatePage.setNameInput('name')]);
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('voipadminApp.department.delete.question');
